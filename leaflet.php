...
<script src="assets/plugins/leaflet-routing/leaflet-routing-machine.min.js"></script>
    ...
    title.update = function () {
      this._div.innerHTML = '<h2>LATIHAN WEBGIS | COVID-19 KABUPATEN SLEMAN</h2>MATAKULIAH PEMROGRAMAN GEOSPASIAL : WEB'
    };
    title.addTo(map);
      /* Image Watermark */
      ...
      onAdd: function(map) {  
      var img = L.DomUtil.create('img');
      img.src = 'assets/img/legenda/legenda.jpeg';
      img.style.width = '300px';
      return img;
      }
     }); 
...
L.control
    ...
    // Layer Marker
    var addressPoints = [
      [-7.7210933, 110.3083938, "KANTOR KAPANEWON SEYEGAN"],
        [-7.68143242, 110.339504, "KANTOR KAPANEWON SLEMAN"],
        [-7.78870307, 110.322063, "KANTOR KAPANEWON GAMPING"],
        [-7.76892956, 110.253352, "KANTOR KAPANEWON MOYUDAN"],
        [-7.72942944, 110.3279779, "KANTOR KAPANEWON MLATI"],
        [-7.69423557, 110.4456639, "KANTOR KAPANEWON NGEMPLAK"],
        [-7.74958568, 110.3952692, "KANTOR KAPANEWON DEPOK"],
        [-7.66720859, 110.4200585, "KANTOR KAPANEWON PAKEM"],
        [-7.65064174, 110.3267707, "KANTOR KAPANEWON TEMPEL"],
      ];
    ...
    L.geoJson(data, {
        style: function(feature) {
            return {color: getColor(feature.properties.jumlah)};
        }
    }).addTo(wfsgeoserver1);
    wfsgeoserver1.addTo(map);
    map.fitBounds(wfsgeoserver1.getBounds());
